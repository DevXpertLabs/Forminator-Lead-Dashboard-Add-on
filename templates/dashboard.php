...
<div class="wrap fld-dashboard">
    <h1 class="fld-page-title">
        ...
        <?php esc_html_e('Lead Dashboard', 'devxpert-lead-dashboard-for-forminator'); ?>
    </h1>

    <!-- Date Range Filter -->
    <div class="fld-filters-bar">
        <div class="fld-date-range">
            <label><?php esc_html_e('Date Range:', 'devxpert-lead-dashboard-for-forminator'); ?></label>
    ...
    <div class="fld-stats-grid">
        <div class="fld-stat-card fld-stat-total">
            ...
            <div class="fld-stat-content">
                ...
                <p><?php esc_html_e('Total Leads', 'devxpert-lead-dashboard-for-forminator'); ?></p>
            </div>
        </div>
        ...
        <div class="fld-stat-card fld-stat-new">
            ...
            <div class="fld-stat-content">
                ...
                <p><?php esc_html_e('New Leads', 'devxpert-lead-dashboard-for-forminator'); ?></p>
            </div>
        </div>
        ...
        <div class="fld-stat-card fld-stat-positive">
            ...
            <div class="fld-stat-content">
                ...
                <p><?php esc_html_e('Positive Leads', 'devxpert-lead-dashboard-for-forminator'); ?></p>
            </div>
        </div>
        ...
        <div class="fld-stat-card fld-stat-negative">
            ...
            <div class="fld-stat-content">
                ...
                <p><?php esc_html_e('Negative Leads', 'devxpert-lead-dashboard-for-forminator'); ?></p>
            </div>
        </div>
        ...
        <div class="fld-stat-card fld-stat-conversion">
            ...
            <div class="fld-stat-content">
                ...
                <p><?php esc_html_e('Conversion Rate', 'devxpert-lead-dashboard-for-forminator'); ?></p>
            </div>
        </div>
    </div>
